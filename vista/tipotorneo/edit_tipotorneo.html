...
<head>
    ...
    <title>Casa del Ajedrez - Editar Tipo de Torneo</title>
...
<div class="page-container">
    ...
    <aside class="sidebar" role="navigation">
            ...
            <nav class="menu">
                ...
                <ul class="menu-list">
                    ...
                    <li class="menu-item active" data-href="../tipotorneo/tipotorneo.html"><div class="icon"><i class="fas fa-chess-queen"></i></div><div class="label">Tipos de Torneo</div></li>
    ...
    <div class="main-content">
        ...
        <div class="form-card">
            ...
            <form onsubmit="return validarEditarTipotorneo(event)">

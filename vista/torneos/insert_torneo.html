...
<head>
    ...
    <title>Casa del Ajedrez - Registrar Torneo</title>
    ...
    <div class="page-container">
        ...
        <div class="main-content">
            <div class="catalog-header">
                <h1 class="page-title"><i class="fas fa-trophy me-2"></i> Registrar Nuevo Torneo</h1>
                ...
                <form role="form" name="form" method="POST" onsubmit="return validarFormularioCompleto(event)" action="./torneo.html">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Ingrese el nombre del torneo" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control" name="fecha" id="fecha" placeholder="AAAA-MM-DD">
                            <div class="invalid-feedback-real" id="fechaFeedback"></div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label required-star">Lugar</label>
                            <input type="text" class="form-control" name="lugar" id="lugar" placeholder="Ciudad / Centro de torneo">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" name="categoria" id="categoria">
                                ...
                                <option value="Abierta">Absoluta</option>
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label required-star">Cupos</label>
                            <input type="text" class="form-control" name="cupos" id="cupos" placeholder="Número de cupos">
                            <div class="invalid-feedback-real" id="cuposFeedback"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" value="Registrar" class="btn btn-primary"><i class="fas fa-save me-2"></i>Registrar Torneo</button>
                    </div>
                </form>
            </div>
        </div>

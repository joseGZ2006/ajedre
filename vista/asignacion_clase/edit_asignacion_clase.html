...
<head>
    ...
    <title>Casa del Ajedrez - Editar Asignación de Clase</title>
...
<body>
    <div class="page-container">
        <aside class="sidebar" role="navigation">
            <div class="logo" style="position: relative;">
                ...
                <button id="closeSidebarBtn" class="sidebar-close-btn" aria-label="Cerrar menú"><i
            ...
            <nav class="menu">
                ...
                <ul class="menu-list">
                    ...
                    <li class="menu-item active" data-href="../clases/asignacion_clase.html">
                        <div class="icon"><i class="fas fa-user-plus"></i></div>
                        <div class="label">Asignación Clases</div>
                    </li>
                ...
                <div style="padding-top:6px">
                    <div
                        ...
                        <i class="fas fa-search" style="color:#7fcfe6"></i><span
                            style="font-size:0.85rem;color:rgba(255,255,255,0.6)">Buscar asignación...</span></div>
                </div>
            </nav>
        </aside>
                ...
                <form role="form" name="form" method="POST" onsubmit="return validarEditarAsignacion(event)"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" name="idEntrenador" id="idEntrenador">
                                ...
                                <option value="1" selected>Marcos Pérez (Especialidad: Ajedrez Básico)</option>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" name="idHorarioClase" id="idHorarioClase">
                                ...
                                <option value="1" selected>Lunes - 09:00 AM a 11:00 AM</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control" name="fechaFin" id="fechaFin" value="2025-06-30">
    ...
    <script>
        function validarEditarAsignacion(event) {
            ...
            if (esValido) {
                const id = document.getElementById('idAsignacionClase').value;
                ...
                Swal.fire({
                    title: '¡Actualizado!',
                    text: `Asignación #${id}: ${alumnoText} con ${entrenadorText} ha sido actualizada correctamente.`,
                    icon: 'success',

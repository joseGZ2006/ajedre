...
-- Tiempo de generación: 03-06-2026 a las 18:32:22
...
CREATE TABLE `ASISTENCIA_ALUMNO` (
  ...
  `estatus` enum('presente','ausente','tarde','justificado') NOT NULL,
...
CREATE TABLE `INSCRIPCION_TORNEO` (
  ...
  `idTorneo` int DEFAULT NULL,
  `fecha` date NOT NULL,
  `estatus` enum('pendiente','confirmado','rechazado','cancelado') NOT NULL,
...
CREATE TABLE `TORNEO` (
  ...
  `categoria` varchar(25) DEFAULT NULL,
  `estatus` enum('proximo','en_curso','finalizado','cancelado') NOT NULL,
  `cupo` int NOT NULL
) ;
...
--
ALTER TABLE `REPRESENTANTE`
  MODIFY `idRepresentante` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `ALUMNO`
  ADD CONSTRAINT `ALUMNO_ibfk_1` FOREIGN KEY (`idRepresentante`) REFERENCES `REPRESENTANTE` (`idRepresentante`),
...
--
ALTER TABLE `ASIGNACION_CLASE`
  ADD CONSTRAINT `ASIGNACION_CLASE_ibfk_1` FOREIGN KEY (`idAlumno`) REFERENCES `ALUMNO` (`idAlumno`),
  ADD CONSTRAINT `ASIGNACION_CLASE_ibfk_2` FOREIGN KEY (`idEntrenador`) REFERENCES `ENTRENADOR` (`idEntrenador`),
  ADD CONSTRAINT `ASIGNACION_CLASE_ibfk_3` FOREIGN KEY (`idHorarioClase`) REFERENCES `HORARIO_CLASE` (`idHorarioClase`);

--
-- Filtros para la tabla `ASISTENCIA_ALUMNO`
--
ALTER TABLE `ASISTENCIA_ALUMNO`
  ADD CONSTRAINT `ASISTENCIA_ALUMNO_ibfk_1` FOREIGN KEY (`idAsignacionClase`) REFERENCES `ASIGNACION_CLASE` (`idAsignacionClase`);

--
-- Filtros para la tabla `ASISTENCIA_ENTRENADOR`
--
ALTER TABLE `ASISTENCIA_ENTRENADOR`
  ADD CONSTRAINT `ASISTENCIA_ENTRENADOR_ibfk_1` FOREIGN KEY (`idEntrenador`) REFERENCES `ENTRENADOR` (`idEntrenador`);

--
-- Filtros para la tabla `CLASIFICACION_FINAL`
--
ALTER TABLE `CLASIFICACION_FINAL`
  ADD CONSTRAINT `CLASIFICACION_FINAL_ibfk_1` FOREIGN KEY (`idTorneo`) REFERENCES `TORNEO` (`idTorneo`),
  ADD CONSTRAINT `CLASIFICACION_FINAL_ibfk_2` FOREIGN KEY (`idAlumno`) REFERENCES `ALUMNO` (`idAlumno`);
...
ALTER TABLE `ENTRENADOR`
  ...
  ADD CONSTRAINT `ENTRENADOR_ibfk_2` FOREIGN KEY (`idEspecialidad`) REFERENCES `ESPECIALIDAD` (`idEspecialidad`);

--
-- Filtros para la tabla `INSCRIPCION_ALUMNO`
--
ALTER TABLE `INSCRIPCION_ALUMNO`
  ADD CONSTRAINT `INSCRIPCION_ALUMNO_ibfk_1` FOREIGN KEY (`idAlumno`) REFERENCES `ALUMNO` (`idAlumno`);

--
-- Filtros para la tabla `INSCRIPCION_TORNEO`
--
ALTER TABLE `INSCRIPCION_TORNEO`
  ADD CONSTRAINT `INSCRIPCION_TORNEO_ibfk_1` FOREIGN KEY (`idAlumno`) REFERENCES `ALUMNO` (`idAlumno`),
  ADD CONSTRAINT `INSCRIPCION_TORNEO_ibfk_2` FOREIGN KEY (`idTorneo`) REFERENCES `TORNEO` (`idTorneo`);

--
-- Filtros para la tabla `PUNTUACION_TEST`
--
ALTER TABLE `PUNTUACION_TEST`
  ADD CONSTRAINT `PUNTUACION_TEST_ibfk_1` FOREIGN KEY (`idAsignacionClase`) REFERENCES `ASIGNACION_CLASE` (`idAsignacionClase`);

--
-- Filtros para la tabla `TORNEO`
--
ALTER TABLE `TORNEO`
  ADD CONSTRAINT `TORNEO_ibfk_1` FOREIGN KEY (`idTipoTorneo`) REFERENCES `TIPO_TORNEO` (`idTipoTorneo`);
COMMIT;

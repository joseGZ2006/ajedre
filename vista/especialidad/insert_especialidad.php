...
<head>
    ...
    <title>Casa del Ajedrez - Registrar Especialidad</title>
    ...
    <div class="page-container">
        ...
        <aside class="sidebar" role="navigation">
            ...
            <nav class="menu">
                ...
                <ul class="menu-list">
                    ...
                    <li class="menu-item active" data-href="../especialidad/especialidad.html">
        ...
        <div class="main-content">
            ...
            <div class="form-card">
                ...
                <form onsubmit="return validarEspecialidad(event)">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nombre" placeholder="Ingrese la especialidad">

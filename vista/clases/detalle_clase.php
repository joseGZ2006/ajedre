...
<head>
    ...
    <title>Casa del Ajedrez - Detalle de Clase</title>
        ...
        <aside class="sidebar" role="navigation">
            ...
            <nav class="menu">
                ...
                <div style="padding-top:6px">
                    <div style="display:flex;align-items:center;gap:8px;padding:8px 12px;background:rgba(255,255,255,0.03);border-radius:40px;">
                        <i class="fas fa-search" style="color:#7fcfe6"></i>
                        <span style="font-size:0.85rem;color:rgba(255,255,255,0.6)">Buscar clase...</span>
                    </div>
                </div>
            </nav>
        </aside>

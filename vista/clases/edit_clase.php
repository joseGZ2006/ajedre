...
<head>
    ...
    <title>Casa del Ajedrez - Editar Clase</title>
...
<body>
    <div class="page-container">
        ...
        <div class="main-content">
            <div class="catalog-header">
                <h1 class="page-title"><i class="fas fa-edit me-2"></i> Editar Clase</h1>
                <a href="./clase.html" class="btn btn-secondary"><i class="fas fa-arrow-left me-2"></i>Volver al catálogo</a>
            </div>

            <div class="form-card">
                <form role="form" name="form" method="POST" onsubmit="return validarEditarClase(event)" action="./clase.html">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="nombre" id="nombre" value="Ajedrez Básico">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="horaInicio" id="horaInicio" value="09:00 AM">
                            <div class="invalid-feedback-real" id="horaInicioFeedback"></div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label required-star">Hora Fin</label>
                            <input type="text" class="form-control" name="horaFin" id="horaFin" value="11:00 AM">
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-primary"><i class="fas fa-save me-2"></i>Actualizar Clase</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script src="../assets/js/validaciones_editclase.js"></script>
</body>
</html>
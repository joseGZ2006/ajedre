...
<head>
    ...
    <title>Casa del Ajedrez - Gestión de Especialidades</title>
    ...
    <aside class="sidebar" role="navigation">
            ...
            <nav class="menu">
                ...
                <ul class="menu-list">
                    ...
                    <li class="menu-item active"data-href="../especialidad/especialidad.html"><div class="icon"><i class="fas fa-chess-king"></i></div><div class="label">Especialidades</div></li>
